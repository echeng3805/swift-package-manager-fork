...
extension SBOMTestModulesGraph {
    ...
    static func createSPMRootExecutableModules(
        ...
        let resolvedPackageCollectionsCommandModule = commandResolvedModules.first { $0.name == "PackageCollectionsCommand" }!
        ...
        let swiftPackageCollectionExecModule = self.createSwiftModule(name: "swift-package-collection", type: .executable)
