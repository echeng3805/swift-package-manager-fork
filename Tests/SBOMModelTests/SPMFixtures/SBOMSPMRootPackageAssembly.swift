...
extension SBOMTestModulesGraph {
    ...
    static func createSPMRootPackageComplete(
        ...
        let allResolvedModules = coreResult.resolvedModules + commandResult.resolvedModules + executableResult.resolvedModules
        ...
        let resolvedPackageCollectionsModelModule = coreResult.resolvedModules.first { $0.name == "PackageCollectionsModel" }!
        let resolvedPackageCollectionsSigningModule = coreResult.resolvedModules.first { $0.name == "PackageCollectionsSigning" }!
        ...
        let resolvedCompilerPluginSupportModule = commandResult.resolvedModules.first { $0.name == "CompilerPluginSupport" }!
