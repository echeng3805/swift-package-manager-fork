    ...
    static func createSwiftlyModulesGraph(rootPath: String = "/tmp/swiftly-mock") throws -> ModulesGraph {
        ...
        let resolvedSwiftlyModule = self.createResolvedModule(
            ...
            dependencies: [
                ...
                .module(
                    self.createResolvedModule(packageIdentity: swiftlyIdentity, module: swiftlyCoreModule),
                    conditions: []
                ),
                .module(
                    self.createResolvedModule(packageIdentity: swiftlyIdentity, module: macOSPlatformModule),
                    conditions: []
                ),
                .product(self.createResolvedProduct(
                    packageIdentity: toolsSupportIdentity,
        ...
        let resolvedSwiftlyCoreModule = self.createResolvedModule(
            ...
            dependencies: [
                .module(
                    self.createResolvedModule(packageIdentity: swiftlyIdentity, module: swiftlyDownloadAPIModule),
                    conditions: []
                ),
                .module(
                    self.createResolvedModule(packageIdentity: swiftlyIdentity, module: swiftlyWebsiteAPIModule),
                    conditions: []
                ),
                .product(self.createResolvedProduct(
                    packageIdentity: httpClientIdentity,
