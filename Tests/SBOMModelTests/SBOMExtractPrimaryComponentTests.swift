...
struct SBOMExtractPrimaryComponentTests {
    ...
    func extractPrimaryComponentFromSPMModulesGraph() async throws {
        ...
        #expect(component.purl == "pkg:swift/github.com/swiftlang/SwiftPM@\(SBOMTestStore.swiftPMRevision)")
        #expect(component.version.revision == SBOMTestStore.swiftPMRevision)
    ...
    func extractPrimaryComponentFromSwiftlyModulesGraph() async throws {
        ...
        #expect(component.name == rootPackage.identity.description)
        #expect(component.id == rootPackage.identity.description)
        #expect(component.purl == "pkg:swift/github.com/swiftlang/swiftly@\(SBOMTestStore.swiftlyRevision)")
        #expect(component.version.revision == SBOMTestStore.swiftlyRevision)
        #expect(component.scope == .runtime)
        #expect(component.description == rootPackage.description)
    ...
    func extractComponentFromProductFromSPMModulesGraph() async throws {
        ...
        #expect(component.version.revision == SBOMTestStore.swiftPMRevision)
        #expect(component.scope == .runtime)
        #expect(component.purl.contains("pkg:swift/github.com/swiftlang/SwiftPM:SwiftPMDataModel@\(SBOMTestStore.swiftPMRevision)"))
    ...
    func extractComponentFromProductFromSwiftlyModulesGraph() async throws {
        ...
        #expect(component.version.revision == SBOMTestStore.swiftlyRevision)
        #expect(component.scope == .runtime)
        #expect(component.purl.contains("pkg:swift/github.com/swiftlang/swiftly:swiftly@\(SBOMTestStore.swiftlyRevision)"))
        #expect(component.description == nil)
