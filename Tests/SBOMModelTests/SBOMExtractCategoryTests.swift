...
struct SBOMExtractCategoryTests {
    ...
    func extractCategoryFromExecutableProduct() throws {
        let resolvedProduct = try SBOMTestModulesGraph.createProduct(name: "MyExecutableProduct", type: .executable, moduleType: .executable)
    ...
    func extractCategoryFromLibraryProduct() throws {
        let resolvedProduct = try SBOMTestModulesGraph.createProduct(name: "MyLibraryProduct", type: .library(.automatic))
        let category = try SBOMExtractor.extractCategory(from: resolvedProduct)
    ...
    func extractCategoryFromTestProduct() throws {
        let resolvedProduct = try SBOMTestModulesGraph.createProduct(name: "MyTestProduct", type: .test, moduleType: .test)
        let category = try SBOMExtractor.extractCategory(from: resolvedProduct)
        #expect(category == SBOMComponent.Category.library)
    }
    ...
    func extractCategoryFromPackageWithExecutable() throws {
        ...
        let resolvedPackage = try SBOMTestModulesGraph.createPackage(name: "ExecutablePackage", products: [executableProduct])
    ...
    func extractCategoryFromPackageWithOnlyLibraries() throws {
        let libraryProduct1 = try SBOMTestModulesGraph.createProduct(name: "MyLibraryProduct1", type: .library(.automatic))
        let libraryProduct2 = try SBOMTestModulesGraph.createProduct(name: "MyLibraryProduct2", type: .library(.dynamic))
        let resolvedPackage = try SBOMTestModulesGraph.createPackage(name: "LibraryPackage", products: [libraryProduct1, libraryProduct2])
        let category = try SBOMExtractor.extractCategory(from: resolvedPackage)
        #expect(category == SBOMComponent.Category.library)
    }
    ...
    func extractCategoryFromPackageWithMixedProductsIncludingExecutable() throws {
        let libraryProduct = try SBOMTestModulesGraph.createProduct(name: "MyLibraryProduct", type: .library(.automatic))
        let executableProduct = try SBOMTestModulesGraph.createProduct(name: "MyExecutableProduct", type: .executable, moduleType: .executable)
        let resolvedPackage = try SBOMTestModulesGraph.createPackage(name: "MixedPackage", products: [libraryProduct, executableProduct])
        let category = try SBOMExtractor.extractCategory(from: resolvedPackage)
        #expect(category == SBOMComponent.Category.application)
    }
    ...
    func extractCategoryFromPackageWithMultipleExecutables() throws {
        let executableProduct1 = try SBOMTestModulesGraph.createProduct(name: "MyExecutableProduct1", type: .executable, moduleType: .executable)
        let executableProduct2 = try SBOMTestModulesGraph.createProduct(name: "MyExecutableProduct2", type: .executable, moduleType: .executable)
        let resolvedPackage = try SBOMTestModulesGraph.createPackage(name: "MultiExecPackage", products: [executableProduct1, executableProduct2])
        let category = try SBOMExtractor.extractCategory(from: resolvedPackage)
        #expect(category == SBOMComponent.Category.application)
    }
